...
public class CustomizationViewController {
     ...
     * @param pizzaType either deluxe,hawaiian, or pepperoni
     */
    @FXML
     ...
     * from that class
     *
     * @param controller that we're using main
     */
    @FXML
     ...
     * in the view with the defaults thus small, 5 toppings for deluxe for example,
