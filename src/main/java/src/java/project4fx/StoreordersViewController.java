...
public class StoreordersViewController {
     ...
     * @param controller its taking in
     */
    ...
    /**
     * Sets the store order to the orders
     * @param orders that we're setting to
     */
    ...
    /**
     * export the file
     * @param event were using
     * @throws FileNotFoundException if bad
     */
    @FXML
